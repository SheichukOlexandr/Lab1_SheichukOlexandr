...
//Задано одновимірний масив А розміру N. Першу половину елементів масиву помножити на 2, а другу - на 3.
...
//Знайти номер останнього мінімального елемента серед парних додатних елементів, що лежать правіше першого від’ємного елемента.
...
//На площині задано множину точок з координатами (x1, y1), (x2, y2), ... (xN, yN), n<=200, і координати вершин трикутника A(xA, yA), B(xB, yB), C(xC, yC). 
//Розробити програму, яка обчслює кількість точок заданої множини, що належать трикутнику ABC. C++
